...
import ImageGallery from "@/app/products/[id]/components/ImageGallery";
import ProductInfo from "@/app/products/[id]/components/ProductInfo";
import ProductCard from "@/app/components/ProductCard";
interface PageProps {
    params: Promise<{ id: string }>;
}
// Server helper to load single product
...
// Server helper to load related items
            ...
            <div className="flex flex-col min-h-screen bg-background">
                ...
                <main className="flex-grow flex flex-col items-center justify-center py-24 text-center space-y-4 px-4">
                    ...
                    <p className="text-xs text-muted-custom max-w-sm">
                        We couldn't locate this specific fancy ornament in our catalog. It may have sold out or been removed.
                    </p>
                    <Link
                        href="/products"
            ...
            <main className="flex-grow">
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16">
                        ...
                        {/* Product description actions right */}
                        <div>
                        ...
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div className="space-y-1 mb-8">
                                ...
                                <p className="text-xs text-muted-custom">
                                    Similar pieces in our {product.category} collection.
                                </p>
                            </div>
