...
import ProductForm from "@/ui/admin/components/ProductForm";
import ProductList from "@/ui/admin/components/ProductList";
import CategoryManager from "@/ui/admin/components/CategoryManager";
    ...
    <div className="space-y-6">
      ...
      {loading && products.length === 0 ? (
        <div className="text-center py-20 text-xs text-muted-custom">
          Loading... Run <code>npm run seed</code> if empty.
        </div>
      ) : (
        <div className="space-y-6">
