          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              {user?.role === "customer" ? (
                ...
                <Link href="/login" className="hidden sm:inline text-xs font-semibold text-muted-custom hover:text-primary">
                  Sign in
                </Link>
              )}
              <Link
            ...
            <div className="pt-2 border-t border-border-custom/50 flex flex-col gap-2">
              {user?.role === "customer" && (
                <Link
                  href="/account"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="block text-center px-4 py-2 border border-border-custom rounded-lg text-sm font-semibold text-primary-dark"
                >
                  My Account
                </Link>
              )}
                          ...
                          <div className="ml-4 flex flex-1 flex-col">
                            <div>
                              <div className="flex justify-between text-sm font-medium">
                                ...
                                <p className="ml-4 text-primary-dark font-bold">{formatINR(item.price * item.quantity)}</p>
                              </div>
                ...
                {cartItems.length > 0 && (
                  <div className="border-t border-border-custom bg-accent-pink/10 px-4 py-6 sm:px-6">
                    <div className="flex justify-between text-base font-semibold text-foreground">
                      <p>Subtotal</p>
                      <p className="text-primary-dark font-bold">{formatINR(cartTotal)}</p>
                    </div>
