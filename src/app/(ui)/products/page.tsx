...
import FilterSidebar from "@/ui/products/components/FilterSidebar";
import ProductGrid from "@/ui/products/components/ProductGrid";
        ...
        async function loadData() {
            try {
                ...
                if (productsRes.ok && categoriesRes.ok) {
                    ...
                    // Calculate max price from dataset
